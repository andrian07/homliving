...
class master_model extends CI_Model {
    ...
    {
        $query = $this->db->query("select * from ms_role a, user_module b, user_module_header c where a.role_id = b.user_role and a.role_id = c.user_module_header_role and a.role_id = '".$id."';");
        $result = $query->result();
        return $result;
    }

    public function update_permission($module, $data)
    {
        $this->db->set($data);
